...
while menu_selection:
        ...
        if int(menu_category) in menu_items.keys():
            ...
            if menu_item_number.isdigit(): 
                ...
                if menu_item_number in menu_items:
                    selected_item_name = menu_items[menu_item_number]["Item name"]
                    print(f'Selected item: {selected_item_name}')
                    


                    # Ask the customer for the quantity of the menu item
                    quantity = input("Please enter the quantity: ").strip()

                    # Check if the quantity is a number, default to 1 if not
                    if quantity.isdigit(): 
                        quantity = int(quantity)
                    else:
                        print("Invalid input. Quantity default set to 1. ")
                    quantity = 1
                ...
                #     print(f"{name.ljust(25)} ${price:.2f} {quantity}")
                    ...
                    print("Error: Please select a valid menu item number.")
            else:
                print("Error: Please input a valid item number.")
    ...
    # print("-------|--------------------------|-------|---------")
for idx, item in enumerate(customer_order, 1):
    name = item["Item name"]
    price = item["Price"]
    quantity = item["Quantity"]
